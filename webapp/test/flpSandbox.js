		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Indirect Labor Task",
									"targetURL": "#comzewmindirect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzewmindirect-display": {
								"semanticObject": "comzewmindirect",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zewmindirect",
									"url": sap.ui.require.toUrl("com/zewmindirect")
								}
							}
						}
					}
